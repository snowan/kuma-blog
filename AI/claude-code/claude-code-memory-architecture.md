...
**Source**: [Claude Code GitHub](https://github.com/anthropics/claude-code) | [Official Docs](https://code.claude.com/docs/en/memory)  
...
### Tier 4: Local Memory (Lowest Priority, Personal Override)
...
| General | Inherited | All | Complex research, modifications |
...
|--------|------------|------------|
| Blocks main | Yes | No |
| User prompts | Pass-through | Pre-approved only |
